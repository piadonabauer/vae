#!/usr/bin/env bash
#SBATCH --job-name=wan_mv_generalization_resume
...
sweep_name=wan_multiview_generalization_resume_all_people_one_expression
...
EXPERIMENTS=(
  #"gen_none__perc1p5__k1em6_resume_all_people_one_expression__baseline_logging|--save_ckpt True --data_preset all_people_one_expression --bucket_config {\"128px_ar1:1\":{9:(1.0,1)}} --debug_stats_every 1 --log_every 1 --eval_every 1 --psnr_guard_max_failures 3|/home/piado/projects/aip-lindell/piado/vae/Open-Sora/outputs/generalization_gen_none__perc1p5__k1em6_256px_logging__job3280616_t2/epoch299-global_step15000"
  "gen_none__perc1p5__k1em6_resume_all_people_one_expression__lr2e4|--save_ckpt True --data_preset all_people_one_expression --bucket_config {\"128px_ar1:1\":{9:(1.0,1)}} --learning_rate 2e-4 --debug_stats_every 1 --log_every 1 --eval_every 1 --psnr_guard_max_failures 3|/home/piado/projects/aip-lindell/piado/vae/Open-Sora/outputs/generalization_gen_none__perc1p5__k1em6_256px_logging__job3280616_t2/epoch299-global_step15000"
  "gen_none__perc1p5__k1em6_resume_all_people_one_expression__lr1e4|--save_ckpt True --data_preset all_people_one_expression --bucket_config {\"128px_ar1:1\":{9:(1.0,1)}} --learning_rate 1e-4 --debug_stats_every 1 --log_every 1 --eval_every 1 --psnr_guard_max_failures 3|/home/piado/projects/aip-lindell/piado/vae/Open-Sora/outputs/generalization_gen_none__perc1p5__k1em6_256px_logging__job3280616_t2/epoch299-global_step15000"
  "gen_none__perc1p5__k1em6_resume_all_people_one_expression__lr2e4_clip05|--save_ckpt True --data_preset all_people_one_expression --bucket_config {\"128px_ar1:1\":{9:(1.0,1)}} --learning_rate 2e-4 --grad_clip 0.5 --debug_stats_every 1 --log_every 1 --eval_every 1 --psnr_guard_max_failures 3|/home/piado/projects/aip-lindell/piado/vae/Open-Sora/outputs/generalization_gen_none__perc1p5__k1em6_256px_logging__job3280616_t2/epoch299-global_step15000"
  "gen_none__perc1p5__k1em6_resume_all_people_one_expression__lr2e4_warmup1k|--save_ckpt True --data_preset all_people_one_expression --bucket_config {\"128px_ar1:1\":{9:(1.0,1)}} --learning_rate 2e-4 --lr_scheduler.warmup_steps 1000 --debug_stats_every 1 --log_every 1 --eval_every 1 --psnr_guard_max_failures 3|/home/piado/projects/aip-lindell/piado/vae/Open-Sora/outputs/generalization_gen_none__perc1p5__k1em6_256px_logging__job3280616_t2/epoch299-global_step15000"
)
